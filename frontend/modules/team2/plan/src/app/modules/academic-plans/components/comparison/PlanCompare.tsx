...
import {getAllPlans, comparePlans} from '../../core/_requests'
                ...
                <div key={plan.id} className='border p-4 rounded'>
                  ...
                  <div>Version: {plan.version}</div>
                    <button
                      ...
                      onClick={() => plan.id !== undefined && removePlanFromCompare(plan.id)}
                      disabled={plan.id === undefined}
                    >
                      Remove
                    </button>
                </div>
