          ...
          <KTCard className='h-100'>
            <KTCardBody className='p-9'>
              ...
              <div className='d-flex flex-wrap mb-5'>
                ...
                <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-2 mb-2'>
                  <div className='fs-6 text-gray-800 fw-bold'>{plan.student_id}</div>
                  <div className='fw-semibold text-gray-400'>Student ID</div>
                </div>
              </div>
              <div className='d-flex justify-content-center'>
                <button
                  className='btn btn-sm btn-light-primary'
                  onClick={() => navigate(`/academics/academic-plans/revisionDetails/${plan.plan_id}`)}
                >
                  View Details
                </button>
              </div>
